...
try:
    from khulnasoft.rbac.orm import create_rbac_db
    from khulnasoft.security import (
        create_user,
        get_users,
        get_roles,
        set_user_role,
    ...
    logging.error("No module 'khulnasoft' found.")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if username not in initial_users:
        ...
        # modify an existing user ("khulnasoft" or "khulnasoft-kui")
    ...
    for def_user in ['khulnasoft', 'khulnasoft-kui']:
