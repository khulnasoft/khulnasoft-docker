...
export NAME=khulnasoft-dashboard
...
# Copy Khulnasoft dashboard certs to install config dir
cp /khulnasoft-certificates/demo.dashboard.pem ${CONFIG_DIR}/certs/dashboard.pem
cp /khulnasoft-certificates/demo.dashboard-key.pem ${CONFIG_DIR}/certs/dashboard-key.pem
cp /khulnasoft-certificates/root-ca.pem ${CONFIG_DIR}/certs/root-ca.pem
