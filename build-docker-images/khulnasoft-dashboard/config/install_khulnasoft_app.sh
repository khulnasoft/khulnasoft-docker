## variables
KHULNASOFT_APP=https://packages.khulnasoft.com/4.x/ui/dashboard/khulnasoft-${KHULNASOFT_VERSION}-${KHULNASOFT_UI_REVISION}.zip
...
if [ "$MAJOR_BUILD" -gt "$MAJOR_CURRENT" ]; then
  KHULNASOFT_APP=https://packages-dev.khulnasoft.com/pre-release/ui/dashboard/khulnasoft-${KHULNASOFT_VERSION}-${KHULNASOFT_UI_REVISION}.zip
