filebeatout1=$(docker exec multi-node_khulnasoft.master_1 sh -c 'filebeat test output')
...
filebeatout2=$(docker exec multi-node_khulnasoft.worker_1 sh -c 'filebeat test output')
